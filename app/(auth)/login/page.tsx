...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-[var(--color-background)] overflow-hidden">
      ...
      <svg
        className="absolute top-0 left-0 w-full h-[55vh] text-[#ff7a1a] fill-current z-0"
      ...
      <div className="relative z-10 flex-1 flex flex-col p-6 pt-12">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-6">
          ...
          <div className="flex flex-col items-center text-center mt-4">
            ...
            <div className="flex flex-col items-center mb-2">
              ...
              />
              <h1 className="text-[40px] font-black tracking-tighter text-[#ff7a1a] drop-shadow-sm mt-1">
                FOREHAND
              </h1>
            </div>
        ...
        <div className="w-full flex flex-col items-center mb-8 space-y-4">
          <button
            ...
            className="w-[340px] h-14 flex items-center justify-center gap-3 rounded-full bg-[#ff7a1a] text-[16px] font-bold text-white transition-all hover:bg-[#ff8a33] active:scale-[0.98] disabled:opacity-70 group"
          >
          ...
          {error && (
            <p className="text-sm font-medium text-red-500 text-center bg-red-500/10 py-2 rounded-lg">
              {error}
            </p>
          )}
